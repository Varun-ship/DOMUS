      ...
      <section className="py-24 bg-warm-stone">
        <div className="max-w-4xl mx-auto px-6">
          <AnimatedSection className="space-y-8 font-inter text-base font-light text-ash-brown/80 leading-relaxed">
            <div>
              <h2 className="font-bodoni text-2xl mb-4">Introduction</h2>
              <p>
            ...
            <div>
              <h2 className="font-bodoni text-2xl mb-4">Information We Collect</h2>
              <p>
            ...
            <div>
              <h2 className="font-bodoni text-2xl mb-4">How We Use Your Information</h2>
              <p>
            ...
            <div>
              <h2 className="font-bodoni text-2xl mb-4">Data Security</h2>
              <p>
            ...
            <div>
              <h2 className="font-bodoni text-2xl mb-4">Your Rights</h2>
              <p>
