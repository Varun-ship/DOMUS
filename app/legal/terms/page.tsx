      ...
      <section className="py-24 bg-warm-stone">
        <div className="max-w-4xl mx-auto px-6">
          <AnimatedSection className="space-y-8 font-inter text-base font-light text-ash-brown/80 leading-relaxed">
            <div>
              <h2 className="font-caudex text-2xl mb-4">Agreement to Terms</h2>
              <p>
            ...
            <div>
              <h2 className="font-caudex text-2xl mb-4">Services</h2>
              <p>
            ...
            <div>
              <h2 className="font-caudex text-2xl mb-4">Booking and Cancellation</h2>
              <p>
            ...
            <div>
              <h2 className="font-caudex text-2xl mb-4">Health and Safety</h2>
              <p>
            ...
            <div>
              <h2 className="font-caudex text-2xl mb-4">Limitation of Liability</h2>
              <p>
            ...
            <div>
              <h2 className="font-caudex text-2xl mb-4">Changes to Terms</h2>
              <p>
